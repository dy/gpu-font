...
Shared-encoder result: the [recovery comparison](bench/encoder-quality.md) selects a 489 KB cross-text encoder with 3,492 script-separated references for 2,004 eligible families. Model/catalog/required modules total 1.72 MB. Historical unseen-family top-1/top-five is 39.59%/63.06%; a fresh phrase confirmation is only 24.41%/45.72%. The reported Lora crop ranks first, but Montserrat still ranks twelfth. Recognition and rejection remain below release readiness.
