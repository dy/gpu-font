...
- [ ] Train with lowercase, title-case and uppercase strings across both renderers; preserve held-out families, confirm on a second frozen phrase bank, and require the reported Lora/Montserrat cases to improve before promoting the encoder.
